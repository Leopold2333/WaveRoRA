def add_dataset_parser(parser):
    ...
    parser.add_argument('--file_name',          type=str,   default='weather.csv',  help='data file')
    ...
    # Whether to utilize RevIn or Stationary techniques for the original data samples
    parser.add_argument('--use_norm',                       default=False,  action='store_true',
                        help='RevIN-like Stationary Models')
